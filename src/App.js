...
function App() {
  return (
    <div className="site-wrap" id="home-section">
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-6 col-md-3 col-xl-4  d-block">
              <h1 className="mb-0 site-logo"><a href="index.html" className="text-black h2 mb-0">codePrentice<span className="text-primary">.</span> </a></h1>
            </div>
            ...
            <div className="col-md-12" style={{ "position": "relative" }} data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="row mb-4" data-aos="fade-up" data-aos-delay="200">
                <div className="col-lg-6 mr-auto">
                  <h1>Open Source bruh moments</h1>
              ...
              <div className="author-box" data-aos="fade-left">
                <div className="d-flex mb-4">
                  ...
                  <div className="mr-auto text-black">
                    <strong className="font-weight-bold mb-0">Grey Simpson</strong>
                          Co-Founder, XYZ Inc.
                </div>
                </div>
            ...
            <div className="col-lg-5 pr-lg-5 mr-auto mt-5 order-2 order-lg-1">
              ...
              <div className="author-box" data-aos="fade-right">
                <div className="d-flex mb-4">
                  ...
                  <div className="mr-auto text-black">
                    <strong className="font-weight-bold mb-0">Kimberly Gush</strong>
                                Co-Founder, XYZ Inc.
                </div>
                </div>
                <blockquote>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus vitae ipsa asperiores inventore aperiam iure?&rdquo;</blockquote>
      ...
      <div className="site-section testimonial-wrap bg-light" id="testimonials-section">
        <div className="container">
          <div className="row mb-5">
            <div className="col-12 text-center">
          ...
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-4 mb-lg-4">
              <div className="h-entry">
                ...
                <h2><a href="#">A community fostering open source development</a></h2>
      ...
      <div className="site-section bg-image2 overlay" id="contact-section" style={{ "background-image": 'images/hero_1.jpg' }}>
        <div className="container">
          <div className="row mb-5">
            <div className="col-12 text-center">
